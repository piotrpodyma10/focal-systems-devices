...
import { DataTableProps, StatusUpdates } from '../../../models/components/common'
...
export default function DataTable({ data }: DataTableProps) {
  ...
  const sortSliceData = (rows: StatusUpdates[]) =>
    stableSort(rows, getComparator(order, orderBy))
      .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
      .map((row: StatusUpdates, index: number) => <Row key={index} row={row} />)
